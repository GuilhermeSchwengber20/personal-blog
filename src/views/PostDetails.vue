<template>
  <div
    class="bg-gradient-to-b from-black to-background lg:h-auto lg:w-full lg:pl-24 lg:pr-8 lg:py-5 flex flex-col"
  >
    <img
      :src="post.urlToImage"
    ...
    <div class="flex flex-col justify-start">
      <h2
        class="font-primary text-2xl uppercase font-bold text-white lg:py-6 lg:px-32"
      >
        {{ post.title }}
      </h2>
      <div class="flex lg:gap-10 lg:px-10">
        ...
        <p
          class="text-[#7C7C7C] font-secondary font-normal lg:mx-2 text-justify"
        >
          {{ post.content }}
        </p>
      </div>
